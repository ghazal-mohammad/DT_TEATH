...
class RemoteLabOrdersRepository
    with PersistentListCache
    implements LabOrdersRepository {
  RemoteLabOrdersRepository(this._remote, this._labRepo, this.persistentCache) {
  ...
  @override
  String get cacheResource => 'lab_orders';
